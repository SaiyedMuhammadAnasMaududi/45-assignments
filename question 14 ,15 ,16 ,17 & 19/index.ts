...
invitedpeople.map((name)=>{
    console.log(
        `Assalamualaikum ${name}!, I hope this Invitation finds you in the best of your health, this invitation is basically to get the honour to have your presence in the dinner I have Arranged for you`
    )})
...
while(invitedpeople.length>2){
 ...
 console.log(invitedpeople)
 invitedpeople.map((name)=>{`Dear ${name}, You're still invited to the dinner 
 Thank You!`})
