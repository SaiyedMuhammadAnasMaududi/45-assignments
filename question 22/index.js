...
let societies = ["Al muslim", "Rizwan", "Haroon", "Areesha"];
// console.log(`the index 2 of societies = ${societies[2]}`)
// societies.splice(2,0,"City Villas")
// console.log(societies)
// societies.indexOf("Haroon")=
console.log("Index error ", societies[5]);
console.log("Indes error resolved ", societies[0]);
