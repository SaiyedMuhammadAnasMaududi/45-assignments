...
else if (lifespanage >= 2 && lifespanage < 4) {
    console.log(`You're a toddler`);
}
else if (lifespanage >= 4 && lifespanage < 13) {
    console.log(`You're a kid`);
}
else if (lifespanage >= 13 && lifespanage < 20) {
    console.log(`You're a Teenager`);
}
else if (lifespanage >= 20 && lifespanage <= 65) {
    console.log(`You're a Adult`);
}
else if (lifespanage > 65) {
